...
use TestBundle\Entity\Photo;
use TestBundle\Form\PhotoType;
...
class PhotoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TestBundle:Photo')->findAll();
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $this->get('photo')->move($entity, $file);
        ...
        return $this->render('TestBundle:Photo:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TestBundle:Photo')->find($id);
        ...
        return $this->render('TestBundle:Photo:show.html.twig', array(
            'entity'      => $entity,
